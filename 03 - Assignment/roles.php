...
<?php require_once "header.php"; ?>
	...
	<div class="row mb-3">
			...
			<form action="" method="post">
				<div class="card">
					...
					<div class="card-footer bg-dark text-right">
						<button type="reset" name="clear" class="btn btn-sm btn-light" id="clearRole">Clear</button>
						<button type="submit" name="submit" class="btn btn-sm btn-light" id="saveRole">Save</button>
					</div>
				</div><!-- card -->
			</form>
		</div><!-- col-sm -->
		<div class="col-sm">
			...
			<table class="table table-striped table-bordered text-center" id="rolesTable"></table>
		</div><!-- col-sm -->
	</div><!-- row -->
