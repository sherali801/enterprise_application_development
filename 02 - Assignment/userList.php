		...
		<table class="table table-striped table-bordered text-center">
			...
			<?php while ($row = mysqli_fetch_assoc($result)) { ?>
				<tr>
					...
					<td class="align-middle"><a href="user.php?id=<?php echo $row["id"]; ?>" class="btn btn-primary">Edit</a></td>
					<td class="align-middle"><a href="deleteUser.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger" onclick="return confirm('Do you want to delete user with ID: <?php echo $row["id"]; ?>')">Delete</a></td>
				</tr>
			<?php } ?>
			</tbody>
		</table>
